...
- Keep card details compact. Store full registry-only details in `docs/agent-registry.md`, not on the visible board cards.
- Keep `docs/agent-registry.md` aligned with any new worker record.
